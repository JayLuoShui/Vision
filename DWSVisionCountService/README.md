...
```text
D:/Demo/Vision/weights/yolo26s-seg-wds-1024-best_int8_openvino_model
```
...
```text
D:/Demo/Vision/dist_installer/DWSVisionCountService_Setup_1.0.0.exe
```

便携目录：

```text
D:/Demo/Vision/dist/DWSVisionCountService_1.0.0_20260607_022925
```
...
- 使用权重：`D:/Demo/Vision/weights/yolo26s-seg-wds-1024-best_int8_openvino_model`
